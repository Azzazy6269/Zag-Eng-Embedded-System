...
Std_ReturnType lcd_4bit_intialize(const chr_lcd_4bits_t * lcd){
   ...
   uint8 l_data_pins_counter= 0;
     if(((void*)0)==lcd){
        ...
        _delay((unsigned long)((20)*((uint64)3200000/4000.0)));
        ret = lcd_4bit_send_command(lcd,0x38);
        _delay((unsigned long)((5)*((uint64)3200000/4000.0)));
        ret = lcd_4bit_send_command(lcd,0x38);
        _delay((unsigned long)((150)*((uint64)3200000/4000000.0)));
        ret = lcd_4bit_send_command(lcd,0x38);
...
static Std_ReturnType lcd_4bit_send_enable_signal(const chr_lcd_4bits_t *lcd){
    Std_ReturnType ret = (Std_ReturnType)0x01 ;
     if(((void*)0)==lcd){
            ...
            _delay((unsigned long)((1)*((uint64)3200000/4000000.0)));
